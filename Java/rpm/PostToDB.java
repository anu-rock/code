    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            for(File file : listOfFiles) {
                ...
                ExtractInfo f = new ExtractInfo(file.getPath());
                packageName = f.packageInfo("NAME");
                packageVersion = f.packageInfo("VERSION");
                packageRelease = f.packageInfo("RELEASE");
                packageGroup = f.packageInfo("GROUP");
                packageSizeInstalled = f.packageInfo("SIZE");
                packagePackager = f.packageInfo("PACKAGER");
                packageUrl = f.packageInfo("URL");
                packageSummary = f.replace(f.packageInfo("SUMMARY"), "\'", "\\\'");
                packageDescription = f.replace(f.packageInfo("DESCRIPTION"), "\'", "\\\'");
