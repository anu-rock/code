...
/* Program to implement arithmetic functions (methods) with the help of exceptions.
 * 
 * Anurag Bhandari
 * 28-09-2009
 */
...
namespace MethodTypes
{
    class Program
    {
        ...
        static int Divide(params int[] values)
        {
            ...
            {
                System.Console.WriteLine("(Cannot divide by zero. Giving result as 0.)");
                return 0;
            }
        }
        ...
        static void Main(string[] args)
        {
            ...
            catch (FormatException e) // this exception is caught when a user enters a non-integer value
            {
                System.Console.WriteLine("\nYou can specify a numeric value only! Exiting now...");
                System.Console.ReadLine();
            }
        }
    }
